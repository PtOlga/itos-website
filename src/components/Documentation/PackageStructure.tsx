        ...
        <ul className="ps-3 md:ps-5 list-unstyled">
          <li className="py-2">
            <div className="flex items-center gap-3">
              <p className="text-xl text-SlateBlue dark:text-darktext" >|—</p>
              <span className="font-medium text-SlateBlue dark:text-darktext">
                <Icon
                  icon="tabler:folder"
                        ...
                        <div className="flex flex-col justify-between gap-2 mt-2">
            {
              Counts.slice(0,30).map((item,index) => {
                return(
                  <p key={index} className="text-xl text-SlateBlue dark:text-darktext" >|</p>
                )
              })
            }
            </div>
...
<p className="text-xl text-SlateBlue dark:text-darktext" >|</p>
                              <div className="flex items-center gap-3">
                                <p className="text-xl text-SlateBlue dark:text-darktext" >|—</p>
                                <span className="font-medium text-SlateBlue dark:text-darktext flex items-center flex-wrap">
                                      <Icon
                                        icon="tabler:folder"
                                        className="text-primary text-base inline-block me-2"
                                      />
