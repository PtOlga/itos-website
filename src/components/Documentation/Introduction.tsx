...
import nextauthImg from "/public/images/documentation/nextauth.webp";
  ...
  return (
    <>
      <div id="version" className="md:scroll-m-[130px] scroll-m-28">
        ...
        <div className="w-full flex justify-between lg:gap-0 gap-6 lg:flex-nowrap flex-wrap p-6 rounded-md border border-solid border-BorderLine dark:border-dark_border">
          {PackageVersions &&
            PackageVersions.map((item) => {
              return (
                <div
                  key={item.id}
                  className="lg:w-1/5 md:w-full text-center lg:border-b-0 border-b border-solid lg:border-e lg:last:border-e-0 last:border-b-0  border-BorderLine dark:border-dark_border"
                >
                  <Image
                    src={item.img}
                    alt="npm-package"
